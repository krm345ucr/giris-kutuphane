namespace WinFormsApp16
{
	partial class Formgiris
	{
		...
		private void InitializeComponent()
		{
			...
			// button1
			// 
			button1.Location = new Point(227, 201);
			...
			// textBox1
			// 
			textBox1.Location = new Point(227, 94);
			...
			// textBox2
			// 
			textBox2.Location = new Point(227, 149);
			...
			label3.Location = new Point(320, 314);
			label3.Name = "label3";
